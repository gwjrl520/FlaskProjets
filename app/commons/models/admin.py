...
class MisAdministrator(BaseModel):
    """
    管理员基本信息
    """
    ...
    administrator_id = db.Column(db.Integer, default=uuid4, primary_key=True, doc='管理员ID')
...
class MisAdministratorGroup(BaseModel):
    """
    管理员组/角色
    """
    ...
    group_id = db.Column(db.Integer, default=uuid4, primary_key=True, doc='管理员角色/组ID')
...
class MisPermission(BaseModel):
    ...
    permission_id = db.Column(db.Integer, default=uuid4, primary_key=True, doc='权限ID')
...
class MisGroupPermission(BaseModel):
    """
    组权限表
    """
    __tablename__ = 'mis_group_permission'

    group_permission_id = db.Column(db.Integer, default=uuid4, primary_key=True, doc='组权限ID')
...
class MisOperationLog(db.Model):
    ...
    operation_log_id = db.Column(db.Integer, default=uuid4, primary_key=True, doc='日志id')
