...
class StatisticsBasic(BaseModel):
    """
    基本统计
    """
    __tablename__ = 'statistics_basic'

    stati_id = db.Column(db.Integer, default=uuid4, primary_key=True, doc='主键id')
...
class StatisticsSearchTotal(BaseModel):
    """
    搜索统计-总数
    """
    __tablename__ = 'statistics_search_total'

    total_id = db.Column(db.Integer, default=uuid4, primary_key=True, doc='主键id')
...
class StatisticsSearch(BaseModel):
    ...
    serach_id = db.Column(db.Integer, default=uuid4, primary_key=True, doc='主键id')
    year = db.Column(db.Integer, doc='年')
    month = db.Column(db.Integer, doc='月')
    day = db.Column(db.Integer, doc='日')
    hour = db.Column(db.Integer, doc='时')
...
class StatisticsSalesTotal(BaseModel):
    """
    销售额统计
    """
    __tablename__ = 'statistics_sales_total'

    sale_id = db.Column(db.Integer, default=uuid4, primary_key=True, doc='主键id')
    area = db.Column(db.Integer, doc='地区')
    money = db.Column(db.Integer, doc='金额(单位:分)')


class StatisticsReadSourceTotal(BaseModel):
    """
    阅读来源统计-总数
    """
    ...
    source_id = db.Column(db.Integer, default=uuid4, primary_key=True, doc='主键id')
